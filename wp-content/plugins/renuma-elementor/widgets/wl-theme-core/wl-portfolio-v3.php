 ...
 * @since 1.0.0
 */
class WlPortfolioV3 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'WL Portfolio V3', 'wl-elementor' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_wl-portfolio-v3',
			[
				'label' => esc_html__( 'WL Portfolio V3 Area', 'wl-elementor' ),
			]	
		);
		...
		$this->add_control(
			...
			[
				...
				'fields' => [
					...
					[
						'name'    => 'portfolio_img',
						'label'   => esc_html__( 'Portfolio Image (Recommend Size 551 * 699)', 'wl-elementor' ),
	...
	<div class="<?php echo wp_kses_post($settings['custom_class']); ?>">
		...
		<?php foreach ( $settings['portfolio_items'] as $item ) : ?>
	        ...
	        <div class="<?php echo wp_kses_post($item['custom_column_class']); ?>">
	            <div class="card card-style7 border-0 rounded-0">
	                    ...
	                    <div class="portfolio-content">
	                        <div class="content-inner">
	                        	<?php if ( '' !== $item['portfolio_category'] ) : ?>
	                            	<span><?php echo wp_kses_post($item['portfolio_category']); ?></span>
	                            <?php endif; ?>

	                            <?php if ( '' !== $item['portfolio_title'] ) : ?>
	                            	<h3 class="h4 mb-0"><a href="<?php echo wp_kses_post($item['portfolio_detail_page_link']); ?>"><?php echo wp_kses_post($item['portfolio_title']); ?></a></h3>
	                            <?php endif; ?>
	                        </div>
	                    </div>
	                </div>
