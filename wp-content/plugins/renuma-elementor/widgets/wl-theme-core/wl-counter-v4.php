 ...
 * @since 1.0.0
 */
class WlCounterV4 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'WL Counter V4', 'wl-elementor' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_wl-counter-v4',
			[
				'label' => esc_html__( 'WL Counter V4 Area', 'wl-elementor' ),
			]	
		);
	...
	<div class="<?php echo wp_kses_post($settings['custom_class']); ?>">
		...
		<?php foreach ( $settings['count_items'] as $item ) : ?>
	        ...
	        <div class="<?php echo wp_kses_post($item['custom_column_class']); ?> wow fadeInUp" data-wow-delay="<?php echo wp_kses_post($item['animation_delay']); ?>ms">
	            <div>
	                <div class="display-6 font-weight-800 text-dark mb-2">
	                	<?php if ( '' !== $item['count_value'] ) : ?>
	                    	<sup class="me-1"><i class="<?php echo wp_kses_post($item['arrow_icon']); ?> text-primary display-24 display-sm-18"></i></sup><?php echo wp_kses_post($item['count_value']); ?>
	                    <?php endif; ?>
	                </div>
	                <?php if ( '' !== $item['count_heading'] ) : ?>
	                	<h3 class="font-weight-700 display-26"><?php echo wp_kses_post($item['count_heading']); ?></h3>
	                <?php endif; ?>

	                <?php if ( '' !== $item['count_content'] ) : ?>
	                	<p class="mb-0"><?php echo wp_kses_post($item['count_content']); ?></p>
	                <?php endif; ?>
	           </div> 
	        </div>
