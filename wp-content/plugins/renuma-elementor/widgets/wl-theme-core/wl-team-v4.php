 ...
 * @since 1.0.0
 */
class WlTeamV4 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'WL Team V4', 'wl-elementor' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_wl-team-v4',
			[
				'label' => esc_html__( 'WL Team V4 Area', 'wl-elementor' ),
			]	
		);
    ...
    <div class="<?php echo wp_kses_post($settings['custom_class']); ?>">
    	...
    	<?php foreach ( $settings['team_items'] as $item ) : ?>
	        ...
	        <div class="<?php echo wp_kses_post($item['custom_column_class']); ?> wow fadeIn" data-wow-delay="<?php echo wp_kses_post($item['animation_delay']); ?>ms">
	            <div class="card card-style8 rounded-0 border-0">
	                ...
	                <div class="card-body text-center p-4">
	                    ...
	                    <?php if ( '' !== $item['team_position'] ) : ?>
	                    	<span class="text-primary"><?php echo wp_kses_post($item['team_position']); ?></span>
	                    <?php endif; ?>
	                </div>
	            </div>
	        </div>
