 ...
 * @since 1.0.0
 */
class WlPortfolioV1 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'WL Portfolio V1', 'wl-elementor' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_wl-portfolio-v1',
			[
				'label' => esc_html__( 'WL Portfolio V1 Area', 'wl-elementor' ),
			]	
		);
		...
		$this->add_control(
			...
			[
				...
				'fields' => [
					[
						'name'    => 'portfolio_img',
						'label'   => esc_html__( 'Portfolio Image (Recommend Size 800 * 615)', 'wl-elementor' ),
	            ...
	            <div class="portfolio-inner">
	                <div class="portfolio-img position-relative">
	                	<?php if ( '' !== $item['portfolio_img']['url'] ) : ?>
	                    	<img src="<?php echo wp_kses_post($item['portfolio_img']['url']); ?>" alt="<?php echo wp_kses_post($item['portfolio_image_alt_tag']); ?>" title="<?php echo wp_kses_post($item['portfolio_image_title_tag']); ?>">
	                    <?php endif; ?>
	                </div>
	                <div class="portfolio-content">
	                	<?php if ( '' !== $item['portfolio_title'] ) : ?>
	                    	<h4 class="mb-3"><a href="<?php echo wp_kses_post($item['portfolio_detail_page_link']); ?>" class="text-white"><?php echo wp_kses_post($item['portfolio_title']); ?></a></h4>
	                    <?php endif; ?>
	                    <div class="portfolio-categories color-white">
	                    	<?php if ( '' !== $item['portfolio_catagory'] ) : ?>
	                        	<a href="<?php echo wp_kses_post($item['portfolio_detail_page_link']); ?>"><?php echo wp_kses_post($item['portfolio_catagory']); ?></a>
	                        <?php endif; ?>
	                    </div>
	                    <?php if ( '' !== $item['arrow_icon'] ) : ?>
	                    	<a class="portfolio-link" href="<?php echo wp_kses_post($item['portfolio_detail_page_link']); ?>"><i class="<?php echo wp_kses_post($item['arrow_icon']); ?>"></i></a>
	                    <?php endif; ?>
	                </div>
	            </div>
	        </div>
