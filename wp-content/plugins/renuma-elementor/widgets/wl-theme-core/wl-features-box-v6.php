 ...
 * @since 1.0.0
 */
class WlFeaturesBoxV6 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'WL Features Box V6', 'wl-elementor' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_wl-features-box-v6',
			[
				'label' => esc_html__( 'WL Features Box V6 Area', 'wl-elementor' ),
			]	
		);
		...
		<?php foreach ( $settings['features_items'] as $item ) : ?>
	        ...
	        <div class="<?php echo wp_kses_post($item['custom_column_class']); ?> wow fadeInRight" data-wow-delay="<?php echo wp_kses_post($item['animation_delay']); ?>ms">
	            ...
	            <?php if ( '' !== $item['features_title'] ) : ?>
	            	<h3 class="mb-0 h5 text-white"><?php echo wp_kses_post($item['features_title']); ?></h3>
	            <?php endif; ?>
	        </div>
