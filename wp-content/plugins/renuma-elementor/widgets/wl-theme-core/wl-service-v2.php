 ...
 * @since 1.0.0
 */
class WlServiceV2 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'WL Service V2', 'wl-elementor' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_wl-service-v2',
			[
				'label' => esc_html__( 'WL Service V2 Area', 'wl-elementor' ),
			]	
		);
		...
		$this->add_control(
			...
			[
				...
				'fields' => [
					...
					[
						'name'    => 'service_img',
						'label'   => esc_html__( 'Service Image (Recommend Size 551 * 733)', 'wl-elementor' ),
    ...
    <div class="<?php echo wp_kses_post($settings['custom_class']); ?>">
    	...
    	<?php foreach ( $settings['service_items'] as $item ) : ?>
	        ...
	        <div class="<?php echo wp_kses_post($item['custom_column_class']); ?> wow fadeInUp" data-wow-delay="<?php echo wp_kses_post($item['animation_delay']); ?>ms">
	            <div class="card card-style28 border-0 position-relative">
	                <div class="service-img position-relative overflow-hidden rounded">
	                	<?php if ( '' !== $item['service_img']['url'] ) : ?>
	                    	<img src="<?php echo wp_kses_post($item['service_img']['url']); ?>" alt="<?php echo wp_kses_post($item['service_image_alt_tag']); ?>" title="<?php echo wp_kses_post($item['service_image_title_tag']); ?>" class="rounded">
	                    <?php endif; ?>
	                </div>
	                <?php if ( '' !== $item['arrow_icon'] ) : ?>
	                	<a href="<?php echo wp_kses_post($item['service_detail_page_link']); ?>" class="service-icon"><i class="<?php echo wp_kses_post($item['arrow_icon']); ?>"></i></a>
	                <?php endif; ?>
	                <div class="card-body position-absolute left-0 bottom-5 z-index-9 px-1-9 px-xxl-2-9">
	                	<?php if ( '' !== $item['service_title'] ) : ?>
	                    	<h3 class="h5 mb-3"><a href="<?php echo wp_kses_post($item['service_detail_page_link']); ?>" class="text-white text-secondary-hover"><?php echo wp_kses_post($item['service_title']); ?></a></h3>
	                    <?php endif; ?>
	                    <?php if ( '' !== $item['service_content'] ) : ?>
	                    	<p class="mb-0 text-white opacity8"><?php echo wp_kses_post($item['service_content']); ?></p>
	                    <?php endif; ?>
	                </div>
	            </div>
	        </div>
