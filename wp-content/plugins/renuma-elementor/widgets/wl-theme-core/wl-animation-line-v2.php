 ...
 * @since 1.0.0
 */
class WlAnimationLineV2 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'WL Animation Line V2', 'wl-elementor' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_wl-animation-line-v2',
			[
				'label' => esc_html__( 'WL Animation Line V2 Area', 'wl-elementor' ),
			]	
		);
		...
		$this->add_control(
			'animation_items',
			[
				'label' => esc_html__( 'Animation Items', 'wl-elementor' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => [
					
					[
						'name'        => 'animation_title',
						'label'       => esc_html__( 'Animation Title', 'wl-elementor' ),
						'type'        => Controls_Manager::TEXTAREA,
						'dynamic'     => [ 'active' => true ],
						'default'     => esc_html__( 'Animation Title' , 'wl-elementor' ),
						'label_block' => true,
					],
					[
						'name'        => 'custom_class',
		...
		$this->add_control(
			'show_banner_animated_line',
			[
				'label'   => esc_html__( 'Show Banner Animated Line', 'wl-elementor' ),
	...
	public function render() {
        ...
        <div class="<?php echo wp_kses_post($settings['slider_class']); ?>">
            <div class="scrolling-marquee">
            	<?php foreach ( $settings['animation_items'] as $item ) : ?>

            		<?php if ( '' !== $item['animation_title'] ) : ?>
	                <h4 class="<?php echo wp_kses_post($item['custom_class']);?>"> <?php echo wp_kses_post($item['animation_title']); ?> </h4>
	                <?php endif; ?>
