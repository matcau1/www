 ...
 * @since 1.0.0
 */
class WlServiceV4 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'WL Service V4', 'wl-elementor' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_wl-service-v4',
			[
				'label' => esc_html__( 'Wl Service V4 Area', 'wl-elementor' ),
			]	
		);
		...
		$this->add_control(
			...
			[
				...
				'fields' => [
					...
					[
						'name'        => 'service_link',
						'label'       => esc_html__( 'Service Link', 'wl-elementor' ),
						'type'        => Controls_Manager::TEXTAREA,
						'dynamic'     => [ 'active' => true ],
						'default'     => esc_html__( 'Service Link' , 'wl-elementor' ),
						'label_block' => true,
					],
					[
						'name'        => 'service_button',
						'label'       => esc_html__( 'Service Button', 'wl-elementor' ),
						'type'        => Controls_Manager::TEXT,
						'dynamic'     => [ 'active' => true ],
						'default'     => esc_html__( 'Service Button' , 'wl-elementor' ),
						'label_block' => true,
					],
					[
	        ...
	        <div class="card card-style18 border-0">
	            <div class="card-body position-relative z-index-9">
	                ...
	                <?php if ( '' !== $item['service_title'] ) : ?>
	                	<h3 class="h4 mb-2"><a href="<?php echo wp_kses_post($item['service_link']); ?>"><?php echo wp_kses_post($item['service_title']); ?></a></h3>
	                <?php endif; ?>
	                ...
	                <?php if ( '' !== $item['service_button'] ) : ?>
	                	<a href="<?php echo wp_kses_post($item['service_link']); ?>" class="service-butn"><?php echo wp_kses_post($item['service_button']); ?></a>
	                <?php endif; ?>
