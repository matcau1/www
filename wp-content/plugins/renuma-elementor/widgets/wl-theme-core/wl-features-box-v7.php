 ...
 * @since 1.0.0
 */
class WlFeaturesBoxV7 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'WL Features Box V7', 'wl-elementor' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_wl-features-box-v7',
			[
				'label' => esc_html__( 'WL Features Box V7 Area', 'wl-elementor' ),
			]	
		);
		...
		$this->add_control(
			...
			[
				...
				'fields' => [
					...
					[
						'name'       => 'features_icon',
						'label'      => esc_html__( 'Features Icon', 'wl-elementor' ),
						'type'       => Controls_Manager::TEXTAREA,
						'dynamic'    => [ 'active' => true ],
					...
					[
						'name'        => 'features_link',
						'label'       => esc_html__( 'Features Link', 'wl-elementor' ),
						'type'        => Controls_Manager::TEXTAREA,
						'dynamic'     => [ 'active' => true ],
						'default'     => esc_html__( 'Features Link' , 'wl-elementor' ),
						'label_block' => true,
					],
					[
						'name'        => 'arrow_icon',
	...
	<div class="<?php echo wp_kses_post($settings['custom_class']); ?>">
		...
		<?php foreach ( $settings['features_items'] as $item ) : ?>
	        ...
	        <div class="<?php echo wp_kses_post($item['custom_column_class']); ?>">
	            <div class="card card-style2 border-0 rounded-0">
	                <div class="card-icon">
	                	<?php if ( '' !== $item['features_icon'] ) : ?>
	                    	<i class="<?php echo wp_kses_post($item['features_icon']); ?>"></i>
	                    <?php endif; ?>
	                </div>
	                <div class="card-body px-1-9 py-1-9 pt-md-6 pb-md-2-3 z-index-1">
	                	<?php if ( '' !== $item['features_title'] ) : ?>
	                    	<h3 class="h4 mb-3"><a href="<?php echo wp_kses_post($item['features_link']); ?>"><?php echo wp_kses_post($item['features_title']); ?></a></h3>
	                    <?php endif; ?>
	                    <?php if ( '' !== $item['features_content'] ) : ?>
	                    	<p class="mb-4"><?php echo wp_kses_post($item['features_content']); ?></p>
	                    <?php endif; ?>
	                    <div class="card-btn">
	                    	<?php if ( '' !== $item['arrow_icon'] ) : ?>
	                        	<a href="<?php echo wp_kses_post($item['features_link']); ?>"><i class="<?php echo wp_kses_post($item['arrow_icon']); ?>"></i></a>
	                        <?php endif; ?>
	                    </div>
	                </div>
	            </div>
