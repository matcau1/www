 ...
 * @since 1.0.0
 */
class WlClientsCarousel extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'WL Clients Carousel', 'wl-elementor' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_wl-clients-carousel',
			[
				'label' => esc_html__( 'WL Clients Carousel Area', 'wl-elementor' ),
			]	
		);
		...
		$this->add_control(
			'client_items',
			[
				'label' => esc_html__( 'Client Items', 'wl-elementor' ),
				...
				'fields' => [
					...
					[
						'name'    => 'client_img',
						'label'   => esc_html__( 'Client Image (Recommend Size 127 * 49)', 'wl-elementor' ),
						'type'    => Controls_Manager::MEDIA,
						'default' => ['url' => Utils::get_placeholder_image_src(),],
						'dynamic' => [ 'active' => true ],
					],
					[						
						'name'       => 'client_image_alt_tag',
    ...
    <div class="<?php echo wp_kses_post($settings['slider_class']); ?>">
    	...
    	<?php foreach ( $settings['client_items'] as $item ) : ?>
	        ...
	        <div class="<?php echo wp_kses_post($item['custom_class']); ?>">
	            <?php if ( '' !== $item['client_img']['url'] ) : ?>
                	<img src="<?php echo wp_kses_post($item['client_img']['url']); ?>" alt="<?php echo wp_kses_post($item['client_image_alt_tag']); ?>" title="<?php echo wp_kses_post($item['client_image_title_tag']); ?>">
                <?php endif; ?>
	        </div>
