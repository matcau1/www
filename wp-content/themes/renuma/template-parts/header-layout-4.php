                                ...
                                <ul>
                                    ...
                                    <?php if(isset($header_button) && !empty($header_button)){?>
                                        <?php if (isset($header_top_button) && $header_top_button) : ?>
                                            <li class="d-none d-xl-inline-block"><a class="btn-style7 md text-white" href="<?php echo esc_url($header_link_button); ?>"><span><?php echo esc_html($header_button); ?></span></a></li>
                                        <?php endif; ?>
                                    <?php }else{?>
                                    <?php } ?>
                                </ul>
