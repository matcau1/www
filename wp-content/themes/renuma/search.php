...
?>
    <div class="container">
        <h1><?php printf( esc_html__( 'Search Results for: %s', 'renuma' ), get_search_query() ); ?></h1>        
    </div>
            ...
            <div class="col-lg-12 mt-n2-9">
                ...
                <?php endwhile; else :?>
                      <div class="search-custom mt-2-9">
                        ...
                        echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'renuma' ) ;?>
                        </h4>
                        <?php get_search_form();?>
                      </div>
                <?php endif;?>
