	...
	public function import_files_config() {
		...
		$home_prevs = array(
			'medinet_home_1' => array(
				'title' => __( 'Import Renuma Theme Data', 'renuma' ),
				'page'  => __( 'Home 1', 'renuma' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/home1.png',
				'preview_link' => 'https://renumawp.websitelayout.net/',
			),
			'medinet_home_2' => array(
				'title' => __( 'Import Renuma Home 2', 'renuma' ),
				'page'  => __( 'Import Renuma Theme Data', 'renuma' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/home2.png',
				'preview_link' => 'https://renumawp.websitelayout.net/?page_id=6265',
			),
			'medinet_home_3' => array(
				'title' => __( 'Import Renuma Home 3', 'renuma' ),
				'page'  => __( 'Import Renuma Theme Data', 'renuma' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/home3.png',
				'preview_link' => 'https://renumawp.websitelayout.net/?page_id=6436',
			),
			'medinet_home_4' => array(
				'title' => __( 'Import Renuma Home 4', 'renuma' ),
				'page'  => __( 'Import Renuma Theme Data', 'renuma' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/home4.png',
				'preview_link' => 'https://renumawp.websitelayout.net/?page_id=11265',
			),
			'medinet_home_5' => array(
				'title' => __( 'Import Renuma Home 5', 'renuma' ),
				'page'  => __( 'Import Renuma Theme Data', 'renuma' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/home5.png',
				'preview_link' => 'https://renumawp.websitelayout.net/?page_id=11493',
			),
			'medinet_home_6' => array(
				'title' => __( 'Import Renuma Home 6', 'renuma' ),
				'page'  => __( 'Import Renuma Theme Data', 'renuma' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/home6.png',
				'preview_link' => 'https://renumawp.websitelayout.net/?page_id=11714',
			),
		);
		...
		foreach ( $home_prevs as $key => $prev ) {
			...
			$config[] = array(
				...
				'import_notice'              => esc_html__( 'Import demo data of renuma.', 'renuma' ),
			);
		}
